...
class ahmedprofile extends StatefulWidget {
  ahmedprofile({super.key});

  @override
  State<ahmedprofile> createState() => _ahmedprofileState();
}

class _ahmedprofileState extends State<ahmedprofile>
                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width:
                                        320, // Modify the width to a finite value
                                    height: 420,
                                    decoration: BoxDecoration(
                                      color: Colors.white,
